		...
		<table>
			...
			<tr class="innerfila">
				<td style="padding: 2px;">
						...
						<select id="mtv<?php echo $item['idItem']?>" name="motivo" class="ajuste_existencias_inv selmtv" data-lista="ct<?php echo $item['idItem']?>">
						...
						<select id="ct<?php echo $item['idItem']?>" name="traspaso" class="ajuste_existencias_inv selcol">
							<?php foreach( $colaboradores as $u ) { if( $u['idColaborador'] != $idc_actual ) { ?>
